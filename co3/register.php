...
include("db_connection.php"); // include the connection object from the DBConnection.php
...
{ 
	...
	if($result > 0)
	 {
		header("location: Register_success.php"); // user will be taken to the success page
	 }
	 else
	 {
		 echo "Oops. Something went wrong. Please try again"; 
		 ?>
		 <a href="Register_success.php">Try Login</a>
		 <?php 
	 }
}
?>
